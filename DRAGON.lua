...
keyboard.inline_keyboard = {
{
{text = '𝐌𝐄𝐃𝐎 𝐄𝐋𝐊𝐁𝐄𝐑', url = "t.me/uu_mido"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/kdksksbdbjsjsksk/3=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 𖠪 اهلا بك في سورس ميكي الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  𖠪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'OSOS🌺',url="t.me/OSDDR"}},
{{text = ' COMANDA ALEX🌺', url="t.me/Elkomanda_y3m"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 MICKEY🌺 ', url="t.me/mickeybott"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mickeybott/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ميدو'  then
local Text = [[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'DEV MEDO ELKBIR🌺',url="t.me/uu_mido"}},
{{text = ' DEV MEDO ELSO8AYR🌺',url="t.me/Enginner_mido"}},
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/UU_matrixx)') 
return false
end
