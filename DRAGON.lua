...
sudo_users = {SUDO,1858220633,1845655031,1859008079}  
...
{text = ' MIDO ELKIBER🌺', url="t.me/Enginner_mido"}},
{{text = ' SOURCE MATRIX🌺 ', url="t.me/UU_matrixx"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
...
local Text = [[
ميدو الكبير  مالك سورس MATRIX للتواصل معه اتبع الزر الاسفل👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'dev mido elkbeer🌺',url="t.me/uu_mido"}},
...
{{text = ':T::O: :A::S::K:', url="t.me/UU_metoren"}},
 {{text = 'بوت التواصل', url="t.me/uu_mido123BOT"}},
 {{text = 'سورس MATRIX', url="t.me/UU_matrixx"}},
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if Constructor(MATRIXg) then  
database:set(bot_id.."my_anamen:status"..MATRIXg.chat_id_,true) 
send(MATRIXg.chat_id_, MATRIXg.id_," 👻تـم تـفعـيل انا مين") 
return false  
end
end
...
if Constructor(MATRIXg) then  
database:del(bot_id.."my_anamen:status"..MATRIXg.chat_id_) 
send(MATRIXg.chat_id_, MATRIXg.id_," 👻 تـم تـعـطـيل انا مين") 
return false end
end

if text == 'انا مين' and DevSoFi(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مبرمج السورس يجامد 😍💚](t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مطور السورس يجامد 😍💚](t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مالك السورس يجامد 😍💚](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and SudoBot(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[نت مطوري تاج راسي 😊](t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and Sudo(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and CoSu(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and Constructor(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and BasicConstructor(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and Manager(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and Mod(MATRIXg) then
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/UU_matrixx)')
return false
end

if text == 'انا مين' and Special(MATRIXg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..MATRIXg.chat_id_)
if not my_ph then
send(MATRIXg.chat_id_, MATRIXg.id_," 👻انا مين معطله") 
return false  
end
send(MATRIXg.chat_id_,MATRIXg.id_, '[ انت مميز ابن ناس 😊 ](t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/UU_matrixx)')
return false
end
...
{{text = 'بوت التواصل', url="t.me/Enginnermido_bot"}}, 
{{text = 'قناه السورس', url="t.me/UU_matrixx"}}, 
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
