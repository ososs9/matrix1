...
sudo_users = {SUDO,1858220633,1845655031,1859008079,1796854502,1863300817}  
...
var = true  
elseif tonumber(user_id) == tonumber(1863300817) then
var = true  
...
{{text = '𝒕𝒐 𝒂𝒔𝒌 😍',url="https://t.me/UU_matrixx"}}, 
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
...
{{text = 'SOURCE MATRIX 🇷🇴',url="https://t.me/UU_matrixx"}}, 
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. MATRIXg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[قناه سورس MATRIX ادخل وتابع الجديد](https://t.me/UU_matrixx)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'MATRIX', url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/UU_matrixx/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://https://t.me/UU_matrixx/99=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = 'تواصل MATRIX  ☑ ➘', url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. MATRIXg.chat_id_ .. '&video=https://https://t.me/UU_matrixx/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦꧁MATRIX ꧂⟧⟝┄┉┉━𖤍' and DevSoFi(MATRIXg) then
local Text = [[ 
[قناه سورس MATRIX ادخل وتابع الجديد](https://t.me/UU_matrixx)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝐒》MATRIX🌺 ', url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://https://t.me/UU_matrixx/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(MATRIXg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](https://t.me/UU_matrixx)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
19• •𖤍━┅┄⟞⟦꧁MATRIX ꧂⟧⟝┄┉━𖤍 {تعني قناه السورس https://https://t.me/UU_matrixx}
20• تحديث السورس { لتحديث السورس خاص بوتك 
21• الغاء { للغاء الامر الذي طلبته }
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. MATRIXg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. MATRIXg.chat_id_ .. '&video=https://t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(MATRIXg.chat_id_,0," 🇷🇴 الـعـضو  : {["..data.first_name_.."](https://t.me/UU_matrixx)}\n 🇷🇴 ["..DRAGON_MATRIXg.."] \n")
end
end,nil)   
DeleteMessage(MATRIXg.chat_id_, {[0] = MATRIXg.id_})     
return false
...
send(MATRIXg.chat_id_,0, " 🇷🇴 عذرا  ⇇{["..data.first_name_.."](https://t.me/UU_matrixx)}\n 🇷🇴 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(MATRIXg.chat_id_,{[0] = MATRIXg.id_})       
return false   
...
[[♢ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 matrix](https://t.me/UU_matrixx)]

[[♢ | MATRIX 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞](https://t.me/UU_matrixx)]

[[♢ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰](https://t.me/UU_matrixx)]
]]

keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'mido elkbeer🇷🇴',url="t.me/uu_mido"}},
{{text = ' mido elso8ayer🇷🇴', url="t.me/Enginner_mido"}},
{{text = 'mrat mido elkbeer🇷🇴',url="t.me/Rohmidoelkbeer"}},
{{text = 'elmodamer🇷🇴',url="t.me/Al_mo_damer"}},
{{text = ' SOURCE MATRIX🇷🇴 ', url="https://t.me/UU_matrixx"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/UU_matrixx/109&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
 
if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 𖠪 اهلا بك في سورس ماتريكس الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  𖠪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'dev medo elkbeer🇷🇴',url="t.me/uu_mido"}},
{{text = ' medo elso8ayer🇷🇴', url="t.me/Enginner_mido"}},
...
local Text = [[
مرات ميدو مطوره سورس ماتريكس للتواصل معه اتبع الزر بالاسفل ♥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Mrat mido elkbeer🌺',url="t.me/Rohmidoelkbeer"}},
...
if text == 'المدمر'  then
local Text = [[
المدمر مالك سورس ماتريكس للتواصل معه اتبع الزر بالاسفل♥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'elmodamer🌺',url="t.me/@Al_mo_damer"}},
...
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MATRIXg.chat_id_ .. '&photo=https://t.me/Al_mo_damer&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = { 
{{text = 'medo elso8ayer🌺',url="t.me/Enginner_mido"}},
{{text = 'medo elkbeer🌺',url="t.me/uu_mido"}},
{{text =  'source matrix' ,url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. MATRIXg.chat_id_ .. '&video=https://t.me/xxvvzm/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'سورس ماتريكس' then
local Text = [[ 
 🇷🇴من أحسن السورسات على التليجرام سورس MATRIX 🇷🇴
حمايه.سرعه.دقه وامان
 قناه السورس 👇
  [◐W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 MATRIX☏](http://https://t.me/UU_matrixx)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴 MATRIX|🌺 ', url="https://t.me/UU_matrixx"}}, 
} 
local MATRIXg_id = MATRIXg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. MATRIXg.chat_id_ .. '&video=https://t.me/UU_matrixx/99&caption=' .. URL.escape(Text).."&reply_to_message_id="..MATRIXg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](https://t.me/UU_matrixx)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1863300817) then  
send(MATRIXg.chat_id_, MATRIXg.id_, " 🇷🇴 لا تسطيع حظر مالك السورس عام")
return false 
end
...
if result.id_ == tonumber(1863300817) then  
send(MATRIXg.chat_id_, MATRIXg.id_, " 🇷🇴 لا تسطيع حظر مالك السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1863300817) then  
send(MATRIXg.chat_id_, MATRIXg.id_, " 🇷🇴 لا تسطيع حظر مالك السورس عام")
return false 
end
...
t = "\n 🇷🇴 قائمه زوجات الجروب \n 🇷🇴═───═❲[《𝐒》MATRIX🌺  ](https://t.me/UU_matrixx)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[꧁MATRIX ꧂](https://t.me/UU_matrixx)❳⟝┄┉┉━⧬'..
'\n 🇷🇴  علامة ال {✓} تعني مفعل'..
'\n 🇷🇴  علامة ال {✘} تعني معطل'..
'\nء𖤍━┅┄⟞⟦꧁MATRIX ꧂⟧⟝┄┉━𖤍'..
'\n'..' 🇷🇴  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 🇷🇴  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🇷🇴  الرفع  ⇇{ '..setadd..
' }\n'..' 🇷🇴  الحظر  ⇇{ '..banm..' }\n\n 🇷🇴═───═❲[《𝐒》MATRIX🌺  ](https://t.me/UU_matrixx)❳═───═ 🇷🇴\n 🇷🇴 قناة سورس MATRIX𖤍━┅┄⟞⟦꧁MATRIX ꧂⟧⟝┄┉━𖤍\n [ ❲[《𝐒》MATRIX🌺  ](https://t.me/UU_matrixx)❳](https://t.me/UU_matrixx) \n'
send(MATRIXg.chat_id_, MATRIXg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂》MATRIX🌺', url="https://t.me/UU_matrixx"}},
}
local MATRIXg_id = MATRIXg.id_/2097152/0.5
...
if text == "تعطيل مين انا"  then
if Constructor(msg) then  
database:del(bot_id.."my_anamen:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 🌠 تـم تـعـطـيل انا مين") 
return false end
end
if text == 'مين انا' and SudoBot(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت مبرمج السورس يروحي😊](https://t.me/UU_matrixx)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](https://t.me/UU_matrixx)')
return false
end
if text == 'مين انا' and DevSoFi(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت مطور السورس يجامد 😍💚](https://t.me/UU_matrixx)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مالك السورس يجامد 😍💚](https://t.me/UU_matrixx)')
return false
end
if text == 'مين انا' and DevSoFi(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and Sudo(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝♦️](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and CoSu(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and Constructor(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and BasicConstructor(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and Manager(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," ??مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and Mod(msg) then
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](https://t.me/UU_matrixx)')
return false
end

if text == 'مين انا' and Special(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," Ⓜ️مين انا معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](https://t.me/UU_matrixx)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](https://t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](https://t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[باي..😺💜](https://t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[عليه الصلاه والسلام..💛🙂](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🇷🇴♥️](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انت الي حلو ياقمر..♥️🦋](https://t.me/UU_matrixx)')
return false
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انا عايز مح انا كمان 🥺💛](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[بتعيط تيب لي طيب..😥](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[ونجيب اشخاص ...😂😜](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[بـعشـقق .🥰❤️](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[وعليكم السلام ..🖤🇷🇴](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[خخخ امال ..😹](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[قامد قموده ..🌝♥️](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[انا اجمد ..🇷🇴💕](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[مش هروح ..😹🇷🇴](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[مش بدودو ..😹🇷🇴](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[الود كبر وبقي عندو بنت ..😻💥](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[عندو كام سنه ..😹💥](https://t.me/UU_matrixx)')
return false
end
end
end
...
send(MATRIXg.chat_id_,MATRIXg.id_, '[القمر مهو بيضكك اهوه ..🇷🇴💕](https://t.me/UU_matrixx)')
return false
end
end
end
...
local Text = [[
[تواصل سورس MATRIX،🍂❤️](https://t.me/UU_matrixx)
]]
keyboard = {} 
keyboard.inline_keyboard = {
