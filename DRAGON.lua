...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Java-ak/matrix1/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1845655031,1614314857,1858220633,1398830949,}   
...
var = true  
elseif tonumber(user_id) == tonumber(1040415235) then
var = true 
...
os.execute('wget https://raw.githubusercontent.com/Java-ak/matrix1/main/DRAGON.lua')
...
{
{text = '𝐌𝐄𝐃𝐎 𝐄𝐋𝐊𝐁𝐄𝐑', url = "https://t.me/uu_mido"},
},
{
{text = '𝐌𝐄𝐃𝐎 𝐄𝐋𝐒𝐎𝐆𝐄𝐑', url = "https://t.me/Enginner_mido"},
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐓𝐑𝐈𝐗', url = "https://t.me/UU_matrixx"}
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطورين السورس⚙',url="t.me/UU_ak0"}},
...
if text == 'ميدو' or text == 'ستينس' or text == '.مم' or text == "مالك السورس" then
local Text =[[
مالك سورس ماتريكس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV MEDO ➪ ',url="t.me/uu_mido"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_mido&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'جافا' or text == 'عمرو' or text == 'Gava' then
local Text = [[
مبرمج السورس
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖱ.𝐃𝐞𝐯 𝐉𝐚𝐯𝐚.ᖲ ',url="t.me/UU_ak0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ميدو الصغير' or text == 'ستينس' or text == '.مم' or text == "مطور السورس" then
local Text =[[
مالك سورس ماتريكس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙈،𝙓𖡼🇻🇦𝑴𝑰𝑫𝑶 𝑬𝑳 𝑺𝑶6𝒀𝑬𝑹❈ٱلْـملْـۅڪْ ➪',url="t.me/Enginner_mido"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(1040415235) then  
send(msg.chat_id_, msg.id_, " ∭ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if result.id_ == tonumber(1040415235) then
send(msg.chat_id_, msg.id_, " ∭ لا يمكنك حظر مالك السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1040415235) then  
send(msg.chat_id_, msg.id_, " ∭ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Java-ak/matrix1/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Java-ak/matrix1/main/File_Bot/"..file)
if res == 200 then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماتريكس').."" then  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'ماتريكس')
local DRAGON_Msg = {
